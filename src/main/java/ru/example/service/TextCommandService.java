...
@Service
public class TextCommandService extends ListenerAdapter {

    private final CommandFormatter commandFormatter;
    private final VoiceConnectionService voiceConnectionService;
    private final Guild guild;
    private final Logger log = LogManager.getLogger(TextCommandService.class);

    public TextCommandService(CommandFormatter commandFormatter, VoiceConnectionService voiceConnectionService, Guild guild) {
